REM Installs CRi Solutions' IntelliJ configs into your user configs.
@echo off
echo Installing CRi Solutions IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'CRiSolutionsAndroid'.
exit /b
